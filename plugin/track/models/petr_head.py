...
class PETRCamTrackingHead(AnchorFreeHead):
    ...
    def forward(self, mlvl_feats, img_metas, query_embeds, reference_points):
        """Forward function.
        Args:
        ...
        # }
        # return outs
        return all_cls_scores, all_bbox_preds, last_query_feats, last_reference_points
    ...
    def get_bboxes(self, preds_dicts, img_metas, rescale=False, tracking=False):
        ...
        for i in range(num_samples):
            ...
            if tracking:
                ...
                obj_idxes = None
                track_scores = None
            ret_list.append([bboxes, scores, labels, obj_idxes, track_scores])
        return ret_list
